 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://ws.mkyong.com/", wsdlLocation = "http://localhost:8080/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://ws.mkyong.com/", "HelloWorldService");
    ...
    public HelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://ws.mkyong.com/", "HelloWorldPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.mkyong.com/", "HelloWorldPort"), HelloWorld.class, features);
    }
