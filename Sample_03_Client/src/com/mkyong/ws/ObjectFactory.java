...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldResponse_QNAME = new QName("http://ws.mkyong.com/", "getHelloWorldResponse");
    private final static QName _GetHelloWorld_QNAME = new QName("http://ws.mkyong.com/", "getHelloWorld");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.mkyong.com/", name = "getHelloWorldResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.mkyong.com/", name = "getHelloWorld")
